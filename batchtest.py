...
if __name__ == '__main__':
    ...
    parser.add_argument('--cand_ratio', type=float, default=0.2, help='ratio of candidate set')
    ...
    parser.add_argument('--max_token', type=int, default=80, help='token number in model response')
    parser.add_argument('--limit', type=int, default=100, help='number of logs for testing, <= 2000*(1-cand_ratio)')
